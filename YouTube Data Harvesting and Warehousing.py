...
#API key connection
def Api_connect():
    Api_Id="AIzaSyBfXLdkhKz70P_gApYZ6_hMLlz4M8tFejk"
...
def streamlit_config():
    ...
    {
    background: rgba(182,183,169,0.6);
    }
    ...
    # title and position
    st.markdown(f'<h1 style="text-align: center; color: #FF5733;">YouTube Data Harvesting and Warehousing</h1>',
...
with st.sidebar:
    ...
    st.markdown(
        """
        Here are the skills you will learn from this project:
        - Python scripting
        - Data Collection
        - MongoDB
        - API Integration
...
show_table = st.radio("SELECT THE TABLE FOR VIEW",(":blue[channels]",":orange[playlists]",":red[videos]",":black[comments]"))
